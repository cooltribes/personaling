                    ...
                    if ($model->save()) {
                        ...
                        if ( isset($_POST['facebook_id']) && $_POST['facebook_id']!="" ) { // de facebook hay que enviar la clave
                            ...
                            $body = '<h2>Te damos la bienvenida a Personaling.</h2>
                                    ...
                                    Por favor valida tu cuenta haciendo click en el enlace que aparece a continuación:
                                    <br/><br/> <a href="' . $activation_url.'"> Haz click aquí </a>';
...
//                                            Yii::app()->user->setFlash('success',UserModule::t("La imágen ha sido cargada exitosamente."));	
                            ...
                            $message = new YiiMailMessage;
                            //Opciones de Mandrill                            
                            $message->activarPlantillaMandrill("plantilla-correo-aplicacion-ps");
