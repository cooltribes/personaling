...
return array (
     ...
     'Clicking " Next" you are indicating that you have read and accepted the Terms and Conditions and Privacy Policy'=>'Clicking "Next" you are indicating that you have read and accepted the <a href=""'.Yii::app()->getBaseUrl().'"/site/terminos_de_servicio" title="Términos y condiciones" target="_blank">Términos de Servicio</a> y la <a href=" "'.Yii::app()->getBaseUrl().'"/site/politicas_y_privacidad" title="Politicas de Privacidad" target="_blank">Privacy Policy</a>.',
     'Clothes'=>'Clothes',
	 ...
	 'Follow our social networks to find out the latest in fashion and trends !'=>'Follow our social networks to find out the latest in fashion and trends !',	
	...
	'How does Personaling.com works?'=>'¿Cómo funciona Personaling?',
     ...
     'ORDER FOR SOMEONE ELSE?'=>'¿COMPRANDO PARA ALGUIÉN MÁS?',
     'Output' => 'Salida',
     ...
     'Please enter a valid email.'=>'Introduzca un correo electronico valido.',
     ...
     'Sizes' => 'Tallas',
     'Subtotal' => 'Subtotal',
     'Subscribe to the mailing list Personaling'=>'Subscribe to the mailing list Personaling',
     'Shipping'=>'Envios',
     ...
     'Your account has not been validated.'=>'Your acoount has not been validated.',
     ...
     'You can buy separate clothes that you like' => 'You can buy separate clothes that you like',
     ...
     'Your body is hourglass because in addition to your shoulders and hips aligned you must have a very defined waist' => 'Your body is hourglass because in addition to your shoulders and hips aligned you must have a very defined waist',
     'Your body is triangle if you have shoulders and tiny waist with a pronounced hips' => 'Your body is triangle if you have shoulders and tiny waist with a pronounced hips',
     'Your body is inverted triangle if you are proportionally broad shoulders and tiny hips' => 'Your body is inverted triangle if you are proportionally broad shoulders and tiny hips',
    ...
    '<h2>You have requested to change your password</h2> To receive a new password, click on the following link: <br/><br/> <a href="{url}">Click Here</a><br/><br/> If you have not been you who requested the change, please contact us via info@personaling.com' => '<h2>Has solicitado cambiar tu contraseña </h2> Para recibir una nueva contraseña haz clic en el siguiente link: <br/><br/> <a href="{url}">Click aquí</a><br/><br/> Si no has sido tu quien ha pedido el cambio, comunícate con nosotros a través de info@personaling.com',
     ...
     'What you will find'=>'LWhat you will find',
	 ...
	 'Which do you identify more style to your everyday life?'=>'Which do you identify more style to your everyday life?',
	 'Which of these looks you would go to party?'=>'Which of these looks you would go to party?',
	 'Which do you identify more style for sports?'=>'Which do you identify more style for sports?',
	 'Which of these looks would go to the office?'=>'Which of these looks would go to the office?',
