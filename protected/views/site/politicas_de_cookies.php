...
$this->pageTitle=Yii::app()->name . ' - Políticas de Cookies';
$this->breadcrumbs=array(
	'Políticas de Cookies',
);
// Open Graph
  Yii::app()->clientScript->registerMetaTag('Personaling.com - Política de Cookies', null, null, array('property' => 'og:title'), null); 
...
<div class="row">
  <div class="span8">
    <div class="box_1">
      <?php echo Yii::t('contentForm','Copy de Cookies'); ?>
    </div>
  </div>
   <!-- SIDEBAR ON -->
