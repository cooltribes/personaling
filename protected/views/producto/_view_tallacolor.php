              <tr>
                <td><input name="" type="text" value="<?php echo $color; ?>" disabled class="input-small uneditable-input"></td>
                <td><input name="" type="text" value="<?php echo $talla; ?>" disabled class="input-small uneditable-input"></td>
