...
// Open Graph
  Yii::app()->clientScript->registerMetaTag('Personaling.com - Política de privacidad o privacidad de datos', null, null, array('property' => 'og:title'), null); 
...
<div class="row">
  <div class="span8">
    <div class="box_1">
      <?php echo Yii::t('contentForm','Copy Politicas de Privacidad'); ?>
    </div>
  </div>
   <!-- SIDEBAR ON -->
