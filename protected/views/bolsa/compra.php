    ...
    <div class="span8 offset2">
      ...
      <section class="bg_color3 margin_top  margin_bottom_small padding_small box_1">
        <p class="alert alert-success"><strong>Tu Pedido ha sido recibido con éxito.</strong> <br/>
          A continuación encontrarás las instrucciones para completar tu compra. (También las hemos enviado a tu correo electrónico: juanpernia@email.com)</p>
        <h1 class="error">Siguiente paso</h1>
        <p><strong>Para completar tu comprar debes:</strong></p>
        <ol>
          <li> <strong>Realizar el pago</strong>: de Bs. XXXX via transferencia electrónica o depósito bancario antes del D-mm-YYYY en una de las siguientes cuentas: <br>
            <br>
            <ul>
        ...
        <hr/>
        <div class="clearfix"><div class="pull-left"><a href="#" class="btn"><i class="icon-print"></i> Imprime estas instrucciones</a></div> <div class="pull-right">      Si ya has realizado el deposito <a href="Proceso_de_Compra_3.php" class="btn btn-mini" >haz click aqui</a></div></div>
      </section>
      <section class="bg_color3 margin_top  margin_bottom_small padding_small box_1">
        <h3>Resumen del pedido </h3>
        <p class="well well-small"><strong>Número de confirmación:</strong> XXXXXX-XX</p>
        ...
        <hr/>
        <p>Hemos enviado un resumen de la compra a tu correo electrónico: <strong>micorreo@ejemplo.com</strong> </p>
        ...
        <!-- Look ON -->
        <h4 class="braker_bottom margin_top">Nombre del Look 1</h4>
        <div class="padding_left">
          <table class="table" width="100%" >
            <thead>
              <tr>
      ...
      <hr/>
      <a href="#" class="btn" title="seguir comprando">Seguir comprando</a> </div>
  </div>
</div>
<!-- /container -->
