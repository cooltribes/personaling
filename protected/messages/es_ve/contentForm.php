...
return array (
	 ...
	 'About Personaling'=>'Acerca de Personaling',
     ...
     'Approve' => 'Aprobar',
     'Approved' => 'Aprobados',
     'Apply for Personal Shopper'=>'Aplicar para Personal Shopper',
     ...
     'Are you a woman / man?'=>'¿Eres mujer/hombre?',
     ...
     'Be the first to receive news and promotions by subscribing to our newsletter.'=>'Sé el primero en recibir noticias y promociones suscribiéndote a nuestro NewsLetter.',
     'Biography' => 'Bio',
	 ...
	 'Forward mail validation.'=>'Reenviar correo de validación',
     'From' => 'De',
     'From1' => 'Desde',
     ...
     'Height' => 'Altura',
     'Here discuss about your Personal Shopper'=>'Aquí hablan de tu Personal Shopper',
	...
	'How does Personaling.com works?'=>'¿Cómo funciona Personaling?',
     ...
     'Invite your Friends'=>'Invita a tus Amig@s',
     ...
     'Password must be at least 4 characters'=>'La contraseña debe tener mínimo 4 caracteres.',
	 ...
	 'Returns Policy'=>'Políticas de Devoluciones',
	 
     'Save' => 'Guardar',
     'Safety Data'=>'Seguridad de Datos',
     ...
     'Terms and Conditions for Personal Shoppers'=>'Términos y condiciones para Personal Shoppers',
     'The bag is empty' => 'La bolsa está vacia',
     'The name must be at least 4 characters'=>'El Nombre debe tener al menos 4 Caracteres',
     'The lastname must be at least 4 characters'=>'El apellido debe tener al menos 4 Caracteres',
	 ...
	 'View all Personal Shoppers'=>'Ver todos los Personal Shopper',	
     ...
     'Your account has not been validated.'=>'Tu cuenta no ha sido validada.',
    ...
    '<h2>You have requested to change your password</h2> To receive a new password, click on the following link: <br/><br/> <a href="{url}">Click Here</a><br/><br/> If you have not been you who requested the change, please contact us via info@personaling.com' => '<h2>Has solicitado cambiar tu contraseña </h2> Para recibir una nueva contraseña haz clic en el siguiente link: <br/><br/> <a href="{url}">Click aquí</a><br/><br/> Si no has sido tu quien ha pedido el cambio, comunícate con nosotros a través de info@personaling.com',
     ...
     'What is your lastname?'=>'¿Cuál es tu apellido?',
	...
	'Looks you love'=>'Looks que te encantan',
	'You can select a look as a favorite by clicking the icon accompanying ♡ , and anytime you can view them by clicking your looks.'=>'Puedes seleccionar un look como <strong>favorito</strong> haciendo clic en el icono <strong> <span class="entypo icon_personaling_medium" style="line-height: 1.1;" >&#9825;</span></strong> que lo acompaña, y en cualquier momento puedes verlos haciendo click en Tus Looks. ',
	'Your orders'=>'Tus Pedidos',
	'Your active orders'=>'Pedidos activos',
	...
	'Your photo'=>'Tu Foto',
	'Your body profile'=>'Tu Perfil Corporal',
	'Your old and past orders'=>'Tus Ordenes antiguas y nuevas',
	...
	'Change email'=>'Cambiar el correo electronico',
	'Change password'=>'Cambiar el password',
	'Notifications'=>'Notificaciones',
	'Address book'=>'Libreta de direcciones',
	'Manage addresses Shipping and Payments.'=>'Gestionar Direcciones de Pagos y Envios',
	'Privacy'=>'Privacidad',
	'Public information'=>'Información pública',
	'Delete account'=>'Borrar cuenta',
	'Invite them using Twitter'=>'Invítalos usando Twitter',
	'Invite them using Facebook'=>'Invítalos usando Facebook',
	'Write your email\'s friends'=>'Ingresa los correos electrónicos de tus amig@s:',
	'Or Invite them using email'=>'O invítal@s por correo electrónico: ',
	'You must enter at least one email address'=>'Debes ingresar al menos una dirección de correo electrónico',
	'Write a personal message'=>'Escribe un mensaje personal:',
	'You must to write a message'=>'Debes escribir un mensaje',
	'Send Invitations'=>'Enviar Invitaciones', 
	'Invite your friends by email'=>'Invita tus amig@s por Correo Electronico',
	'Control panel'=>'Panel de Control',
	'Your profile'=>'Tu perfil',
	'Policies and privacy'=>'Políticas y privacidad',
	'Conditions of shipments and parcels'=>'Condiciones de Envíos y Encomiendas',
	'Other links'=>'Otros links',
	'View cart'=>'Ver carrito',
	'You must validate your account before continuing. We\'ve sent a new validation link'=>'Debes validar tu cuenta para continuar. Te hemos enviado un nuevo enlace de validación a ',
	'View notifications'=>'Ver notificaciones',
	'Your notifications'=>'Tus notificaciones',
	'Click on one of your posts to display its contents.'=>'Haz click en uno de tus mensajes para visualizar su contenido.',
	'Register Payment'=>'Registrar Pago',
	'View Details'=>'Ver Detalles',
	'See Shipping and Returns Policies' => 'Ver Políticas de Envíos y Devoluciones',
	'Update all' => 'Actualizar todo',
	'Shipping and billing address' => 'Dirección de envío y facturación',
	'Save my address'=>'Guardar en mis direcciones',
	'I have a discount code!'=>'Tengo un código de descuento!',	
	'Redeem Gift Card'=>'Canjear Gift Card',
	'Summary of the purchase' => 'Resumen de la compra',
	'Awaiting Payment'=>'En espera de pago',
	'Awaiting Confirmation'=>'En espera de confirmación',
	'Confirmed payment'=>'Pago confirmado',
	'Envoy'=>'Enviado',
	'Canceled'=>'Cancelada',
	'Payment declined'=>'Pago rechazado',
	'Underpayment'=>'Pago insuficiente',
	'Delivered'=>'Entregada',
	'Back'=>'Devuelta',
	'Partially restored'=>'Parcialmente devuelta',
	'Finalized'=>'Finalizada',
	
	
	'Transaction ID'=>'ID de Transaccion',
	'Pending payable'=>'Pendientes por pagar',
	'TBC pending'=>'Pendientes por confirmar',
	'Already paid'=>'ya pagado',
	'Shipping address' => 'Dirección de envío',
	'Receipt of payment'=>'Recibo de pago',	
