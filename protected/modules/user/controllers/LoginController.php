		...
		if (Yii::app()->user->isGuest) {
			...
			if(isset($_POST['UserLogin']))
			{
				...
				if($model->validate()) {
					...
					if (UserModule::isAdmin()){
						...
						if(isset(Yii::app()->session['redirect'])){
							if(Yii::app()->session['redirect'] == 'recomendations'){
								$this->redirect(array('/site/recomendaciones'));
							}
						}else{
 			...
 			if (isset($_GET['redirect'])) {
 				if($_GET['redirect'] == 'recomendations'){
 					Yii::app()->session['redirect'] = $_GET['redirect'];
 				}
 			}
