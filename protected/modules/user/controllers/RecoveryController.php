				...
				if ($email&&$activkey) {
			    	...
			    	if(isset($_POST['UserRecoveryForm'])) {
			    		...
			    		if($form->validate()) {
							...
							$body = '<h2>Has solicitado cambiar tu contraseña de Personaling.</h2> Para recibir una nueva contraseña haz clic en el siguiente link:<br/><br/> <a href="' . $activation_url.'"> Haz click aquí </a>';
