  ...
  <footer class="container">
    <div class="row hidden-phone">
      ...
      <div class="span5 ">
        ...
        <div class="row-fluid"><div class="span8"><img class="margin_top_medium_minus at_exclude" src=" <?php echo Yii::app()->getBaseUrl(); ?>/images/ve/logos_seguridad.png" alt="Logos de Seguridad">
