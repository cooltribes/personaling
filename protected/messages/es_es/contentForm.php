...
return array (
	...
	'Personaling.com' => 'Personaling.es',
	'Previous'=>'Anterior',
	'Print' => 'Imprimir',
    ...
    '<h2>Welcome to Personaling.es!</h2>  We want to welcome you to live your first Shopping Experience unique and… repeatable.<br/>Your registration has been successfully validated.<br/>Your temporary password is: <strong>{code}</strong><br/>This password can change it by logging into your account and clicking on "Change Password". The next step you must take is to validate your account by clicking this link:<br/> <a href="{activation_url}">Click here</a>'=>
    '<h2>¡Bienvenido a Personaling.es!</h2>  Queremos darte la bienvenida a vivir tu primera Shopping Experience única y… repetible. <br/><br/>Tu registro se ha validado con éxito.<br/><br/> Tu contraseña provisional es: <strong>{code}</strong><br/><br/> Esta contraseña puedes cambiarla accediendo a tu cuenta y clicando en “cambiar contraseña”. El siguiente paso que debes dar es validar tu cuenta clicando en este enlace:<br/><br/> <a href="{activation_url}">Clica aquí</a>',
