                     ...
                     <li class="span4 box_elemento">
                        <div class="thumbnail"> 
                          ...
                          <div class="caption">  <h3>Icono</h3>
                            ...
                            <a href="<?php echo Yii::app()->theme->baseUrl ?>/images/activos_graficos/Icono/Personaling_kit_icono.zip" title="Blonco y negro, positivo,..." class="btn btn-info btn-block">Descargar Kit del icono</a>
