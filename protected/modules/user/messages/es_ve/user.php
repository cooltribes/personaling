...
return array(
    ...
    'Or use your credentials personaling' => 'O usa tus credenciales de personaling:',
    'Enter' => 'Entrar',
    ...
    'Incorrect password (minimal length 4 symbols).' => 'La contraseña debe tener mínimo 4 caracteres.',
    ...
    'Minimal password length 4 symbols.' => 'La contraseña debe tener mínimo 4 caracteres.',
    'Lost Password?' => '¿Olvidaste tu contraseña?',
    'Profile' => 'Perfil',
    'activation key' => "Clave de activación",
    'User activation' => "Activación de usuario",
    'You account is active.' => '<p class="alert alert-info lead margin_bottom_large padding_xsmall">Tu cuenta está <b>activa</b>.</p>',
    'You account is activated.' => '<p class="alert alert-success lead margin_bottom_large padding_xsmall">Tu cuenta está <b>activada</b>.</p>',
    'Incorrect activation URL.' => '<p class="alert alert-error lead margin_bottom_large padding_xsmall"><b>Error</b>: La URL de activación es incorrecta.</p>',
