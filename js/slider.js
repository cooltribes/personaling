...
function doRight(speed) {
	...
	*/	
	...
	$(".image_not_bw").animate({opacity: op75},  { duration: speed, queue: false }).prev().animate({opacity: op50},  { duration: speed, queue: false }).prev().animate({opacity: op25},  { duration: speed, queue: false }).prev().animate({opacity: '0'},  { duration: speed, queue: false });
	$(".image_not_bw").next().find('img:first').stop().animate({opacity:1}, speed);
	$(".image_not_bw .img_grayscale").stop().animate({opacity:0}, speed);	
	$(".image_not_bw").addClass("image_bw").removeClass("image_not_bw").next().removeClass("image_bw").addClass("image_not_bw");	
	init_center+=core;
}
...
*/
	...
	$(".image_not_bw").animate({opacity: op75},  { duration: speed, queue: false }).next().animate({opacity: op50},  { duration: speed, queue: false }).next().animate({opacity: op25},  { duration: speed, queue: false }).next().animate({opacity: '0'},  { duration: speed, queue: false });
	//
	$(".image_not_bw").prev().find('img:first').stop().animate({opacity:1}, speed);
	$(".image_not_bw .img_grayscale").stop().animate({opacity:0}, speed);
	$(".image_not_bw").addClass("image_bw").removeClass("image_not_bw").prev().removeClass("image_bw").addClass("image_not_bw");
