        ...
        <div class="row">
            <div class="span8 offset2 text_align_center margin_top">
                <div class="box_home  margin_bottom_small">
                    <h1>¡Bienvenido a Personaling! </h1>
                    <h3>¡Tu Personal Shopper Digital!</h3>
                    <p>Ofrecemos el servicio gratuito de Personal Shopper digital para todas aquellas chicas que quieren vestir de manera increíble y comprar sus marcas favoritas a precios inmejorables con recomendaciones personalizadas adaptadas a tu cuerpo, piel, color de ojos y hasta evento para el que quieras vestir. </p>
                    <p><strong>¿Qué esperas?</strong></p>
                    <a href="<?php echo Yii::app()->getBaseUrl(); ?>/user/registration" title="Registrate" class="btn btn-danger btn-large">¡Regístrate YA!</a> </div>
