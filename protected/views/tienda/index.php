  ...
  <div class="row">
    <div class="span3">
      <div class="shadow_1">
        ...
        <input type="text" placeholder="Buscar por palabras clave"  class="span3">
        <a href="#" title="Buscar" class="btn">Buscar</a>
        <hr/>
        <div class="row tienda_iconos">
          <div class="span1"><img src="http://placehold.it/70x70" />Zapatos</div>
          <div class="span1"><img src="http://placehold.it/70x70" />Accesorios</div>
          <div class="span1"><img src="http://placehold.it/70x70" />Pantalones</div>
          <div class="span1"><img src="http://placehold.it/70x70" />Camisas</div>
          <div class="span1"><img src="http://placehold.it/70x70" />Franelas</div>
          <div class="span1"><img src="http://placehold.it/70x70" />Tops</div>
          <div class="span1"><img src="http://placehold.it/70x70" />Zapatos</div>
        </div>
        <hr/>
