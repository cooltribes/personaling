...
this.op.url= op.url||"http://www.browsehappy.com";
//this.op.url= "http://www.youtube.com";
...
if (languages.indexOf(ll)!==false)
    ...
    this.op.url="http://www.browsehappy.com/";
var tar="";
...
div.id="buorg";
div.className="buorg";
div.innerHTML= '<div><i class="icon-warning-sign"></i>' + this.op.text + '<div id="buorgclose">X</div></div>';
